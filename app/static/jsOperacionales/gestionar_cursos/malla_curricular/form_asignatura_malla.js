...
var app = new Vue({
    ...
    , methods: {
        ...
        , anularAsignatura(obj) {
            const op = confirm('Desea anular esta asignatura?');
            if (op) {
                const data = {
                    malla_id: this.idmalla,
                    cur_id: this.cur_id,
                ...
                axios
                .put(`/cursos/malla_curricular/anular_asignatura`, data)
                .then(res => {
                    if (res.data.estado) {
                        this.obtenerAsignaturasCurso();
                        $.alert({
                        ...
                        throw new Error("Hubo un problema al anular");
                    }
                })
                .catch(error => {
                    console.error(error);
