...
from app.rutas.referenciales.cargos.cargos_routes import car
...
from app.rutas.referenciales.permisos.permisos_routes import perm
...
from app.rutas.gestionar_cursos.planificacion_examen.planificacion_examen_routes import ple
from app.rutas.gestionar_cursos.calificacion_alumno.calificacion_alumno_routes import calif_al
...
# Otras instancias
from app.rutas.cuenta_usuario.cuenta_usuario_routes import cu
...
modulo0 = '/mantenimiento_seguridad'
...
app.register_blueprint(car, url_prefix=f'{modulo0}/cargos')
...
app.register_blueprint(perm, url_prefix=f'{modulo0}/permisos')
...
app.register_blueprint(ple, url_prefix=f'{modulo3}/planificacion_examen')
app.register_blueprint(calif_al, url_prefix=f'{modulo3}/calificacion_examen')
...
# Otras rutas
app.register_blueprint(cu, url_prefix='/usuario')
